...
if __name__ == '__main__':
    ...
    evalrank("/Data1/zengsheng/works/dl_works/person/flick1/LHSC/runs/LHSC/checkpoint/model_best.pth.tar",
             data_path="/Data1/zengsheng/works/dl_works/person/flickr_datas", split="test", fold5=False)
